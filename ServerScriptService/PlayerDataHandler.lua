...
local toggleLockItemEvent = remoteEventsFolder:FindFirstChild("ToggleLockItemEvent") or Instance.new("RemoteEvent")
toggleLockItemEvent.Name = "ToggleLockItemEvent"
toggleLockItemEvent.Parent = remoteEventsFolder

toggleLockItemEvent.OnServerEvent:Connect(function(player, robloxId, serialNumber)
        ...
        local newLockedState = DataStoreAPI:ToggleLockItem(player, robloxId, serialNumber)
