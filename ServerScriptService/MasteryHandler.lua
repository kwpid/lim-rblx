...
local awardMasteryBadgeFunction = Instance.new("RemoteFunction")
awardMasteryBadgeFunction.Name = "AwardMasteryBadgeFunction"
awardMasteryBadgeFunction.Parent = remoteEventsFolder
...
awardMasteryBadgeFunction.OnServerInvoke = function(player, collectionName)
