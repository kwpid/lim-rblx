...
- **Lower Item Drop Rates**: Changed probability power from 0.9 to 1.0 to make rare items significantly more rare. This creates a steeper rarity curve making high-value items harder to obtain. For example, a 10M Robux item is now approximately 60% harder to roll than with 0.9 power.
