...
- **2025-11-02**: Added ViewInventory feature to trade UI - players can now view another player's inventory by clicking the ViewInventory button in PlayerFrame during trade request. Feature includes proper cleanup when switching between players and closing the view.
