...
function refresh()
	...
	for i, listing in ipairs(listings) do
		...
		button.MouseButton1Click:Connect(function()
			...
			local userInfo = buyInfo:FindFirstChild("UserInfo")
			if userInfo then
			...
			local itemInfo = buyInfo:FindFirstChild("ItemInfo")
			if itemInfo then
			...
			local buyPriceLabel = buyInfo:FindFirstChild("BuyPrice")
			...
			local confirmBtn = buyInfo:FindFirstChild("Confirm")
			if confirmBtn then
...
local cancelBtn = buyInfo:FindFirstChild("Cancel")
if cancelBtn then
